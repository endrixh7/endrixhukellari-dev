...
<footer id='footer' className="text-center ">
  ...
  <div className="flex justify-center items-center">
    <a
      ...
      aria-label="Endri Xhukellari's Twitter/X"
    >
      <svg
    ...
    <a
      ...
      className="mr-6" rel="noreferrer"
      aria-label="Endri Xhukellari's Instagram"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-4 w-4"
    ...
    <a
      ...
      className="mr-6" rel="noreferrer"
      aria-label="Endri Xhukellari's LinkedIn"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-4 w-4"
    ...
    <a href="https://github.com/endrixh7" target='_blank' rel="noreferrer">
      <svg
        ...
        fill="currentColor"
        viewBox="0 0 24 24"
        aria-label="Endri Xhukellari's Github"
      >
